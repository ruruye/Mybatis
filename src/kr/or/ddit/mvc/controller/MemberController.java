...
public class MemberController {
   ...
   // 시작 메서드
    ...
    private void updateMember2() {
	   ...
	   int num;	 // 수정을 원하는 항목의 선택번호가 저장될 변수
	   ...
	   do {
		   ...
		   switch (num) {
			case 1:
				updateField = "mem_pass"; updateTitle = "비밀번호";
				break;
			case 2:
				updateField = "mem_name"; updateTitle = "회원이름";
				break;
			case 3:
				updateField = "mem_tel"; updateTitle = "전화번호";
				break;
			case 4:
				updateField = "mem_addr"; updateTitle = "회원주소";
				break;
			default:
	   ...
	   map.put("field", updateField); // 수정할 컬럼명
	   map.put("data", updateData);  // 수정할 데이터 셋팅
 	   
 	   int cnt = service.updateMember2(map);
      
       if(cnt>0) {
          System.out.println(memId + " 수정 작업 성공!!");
       } else {
          System.out.println(memId + " 수정 작업 실패~~");
      }
   }
    ...
    private void updateMember() {
 	  ...
 	  if(cnt>0) {
          System.out.println(memId + " 회원정보수정성공");
       } else {
          System.out.println(memId + " 회원정보수정실패");
       }
   }    
